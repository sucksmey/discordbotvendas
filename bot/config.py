...
PRIVATE_ACTIONS_LOG_CHANNEL_ID = 1394112959436820520 # NOVO: Logs de ações privadas (histórico, consultar preços)

# --- IDs de Fidelidade e Sorteio ---
LOYALTY_NOTIFICATION_CHANNEL_ID = 1380180609653018735
GIVEAWAY_CHANNEL_ID = 0 # Preencha com o ID do canal principal de sorteios (se houver)
...
PRODUCTS = {
    "Robux": {
        "emoji": "💎",
        "type": "robux", # Tipo para lógica específica (automação)
        ...
        "vip_prices": { "1000 Robux": 36.90 } # Exemplo, VIP pode ter preços diferentes
    },
